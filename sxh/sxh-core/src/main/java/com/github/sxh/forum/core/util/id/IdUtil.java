package com.github.sxh.forum.core.util.id;

import com.github.sxh.forum.core.async.AsyncUtil;
import com.github.sxh.forum.core.util.CompressUtil;
import com.github.sxh.forum.core.util.id.snowflake.PaiSnowflakeIdGenerator;
import com.github.sxh.forum.core.util.id.snowflake.SnowflakeProducer;

import static com.github.sxh.forum.core.util.CompressUtil.int2str;

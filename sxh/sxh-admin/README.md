...
🚀🚀🚀 sxh-admin，技术派管理端，基于 React18、React-Router v6、React-Hooks、Redux、TypeScript、Vite3、Ant-Design 5.x、Hook Admin、ECharts 的一套社区管理系统，够惊艳哦。
<br><br>
<p align="center">
  ...
  <a href="https://github.com/itwanger/sxh-admin" target="_blank"><img src="https://img.shields.io/badge/技术派-管理端-yellow.svg?style=for-the-badge"></a>
  <a href="https://gitee.com/itwanger/sxh-admin" target="_blank"><img src="https://img.shields.io/badge/码云-项目地址-blue.svg?style=for-the-badge"></a>
</p>
...
- GitHub：[https://github.com/itwanger/sxh-admin](https://github.com/itwanger/sxh-admin)
- 码云：[https://gitee.com/itwanger/sxh-admin](https://gitee.com/itwanger/sxh-admin)
...
```text
# GitHub
git clone https://github.com/itwanger/sxh-admin.git
```
...
[![Star History Chart](https://api.star-history.com/svg?repos=itwanger/sxh-admin&type=Date)](https://star-history.com/#itwanger/sxh-admin&Date)

...
// ############# 排行榜相关的请求 #############
export const ACTIVITY_RANK_URL = 'rank'

// ############# 首页相关的请求 #############
// 获取指定category下的文章列表
export const CATEGORY_ARTICLE_LIST_URL = 'article/api/articles/category'
// 获取指定tag下的文章列表
export const TAG_ARTICLE_LIST_URL = 'article/api/articles/tag'
...
// 文章相关推荐
export const ARTICLE_RELATED_URL = 'article/api/recommend/related'

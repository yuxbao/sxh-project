...
import com.yizhaoqi.smartpai.service.ArticleKnowledgeService;
...
public class IntegrationController {
    ...
    private final com.yizhaoqi.smartpai.service.SxhBridgeAuthService sxhBridgeAuthService;
    ...
    public ResponseEntity<?> createSsoLogin(
        ...
        String bridgeCode = sxhBridgeAuthService.createBridgeCode(
                new com.yizhaoqi.smartpai.service.SxhBridgeAuthService.SxhUserPayload(
                        request.sxhUserId(),
                        request.userName(),
                        request.displayName(),
                        request.avatar(),

...
MYSQL_PASSWORD="PaiSmart2025"
ELASTIC_PASSWORD="PaiSmart2025"
MINIO_USER="admin"
MINIO_PASSWORD="PaiSmart2025"
...
echo "初始化 MySQL 数据库..."
docker exec mysql mysql -uroot "-p$MYSQL_PASSWORD" -e "CREATE DATABASE IF NOT EXISTS PaiSmart DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"

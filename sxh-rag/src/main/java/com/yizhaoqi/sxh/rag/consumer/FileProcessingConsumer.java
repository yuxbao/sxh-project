package com.yizhaoqi.sxh.rag.consumer;

import com.yizhaoqi.sxh.rag.config.KafkaConfig;
import com.yizhaoqi.sxh.rag.model.FileProcessingTask;
import com.yizhaoqi.sxh.rag.service.ParseService;
import com.yizhaoqi.sxh.rag.service.VectorizationService;
    ...
    private InputStream downloadFileFromStorage(String filePath) throws ServerException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException, InternalException {
        ...
        try {
            ...
            if (filePath.startsWith("http://") || filePath.startsWith("https://")) {
                ...
                // 添加必要的请求头
                connection.setRequestProperty("User-Agent", "sxh-rag-FileProcessor/1.0");

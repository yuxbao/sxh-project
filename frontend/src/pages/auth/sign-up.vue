    ...
    <div class="p-8 b-1 b-white/6 rd-4 b-solid bg-white/10 shadow">
      ...
      >
        ...
        <a-form-item label="passwordAgain" name="passwordAgain">
          <a-input v-model:value="form.passwordAgain" placeholder="请再次输入您的密码">
            <template #prefix>
              <div i-ant-design-lock-outlined color="#999" />
            </template>
          </a-input>
        ...
        <a-button type="primary" html-type="submit" mt-4 block>
          创建账号
        </a-button>
        <a-button type="text" mt-4 block @click="nav2SignIn">
          返回登录
        </a-button>
      </a-form>
    </div>
